...
namespace Theory_of_game_1._2
{
    public class Reader
    {
        ...
        double readSimbol()
        {
            ...
            if (imput[reading_mark] == 's')
            {
                reading_mark++;
                if (imput[reading_mark] == 'i')
                {
                    reading_mark++;
                    if (imput[reading_mark] == 'n')
                    {
                        reading_mark++;
                        return (-11);
                    }
                }
                if (imput[reading_mark] == 'q')
                {
                    reading_mark++;
                    if (imput[reading_mark] == 'r')
                    {
                        reading_mark++;
                        if (imput[reading_mark] == 't')
                        {
                            reading_mark++;
                            return (-14);
                        }
            ...
            if (imput[reading_mark] == 'c')
            {
                reading_mark++;
                if (imput[reading_mark] == 'o')
                {
                    reading_mark++;
                    if (imput[reading_mark] == 's')
                    {
            ...
            if (imput[reading_mark] == 'a')
            {
                reading_mark++;
                if (imput[reading_mark] == 'b')
                {
                    reading_mark++;
                    if (imput[reading_mark] == 's')
                    {
